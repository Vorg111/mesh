<?php 
    ...
    if (R::findOne('meshbotusers', 'tg_id = ?', array($userId))) {
        ...
        $keyboard = [
            'inline_keyboard' => [
                [["text" => "🔵 Переподключить МЭШ", "url" => "https://school.mos.ru?backUrl=https://vorg.site/meshdnevnik_bot/redirect.php?id=".$userId]]
            ],
        ];
        
        $message = "😓 К сожалению ваша сессия авторизации подошла к концу. В целях безопасности мы попросим вас переподключить ваш аккаунт. Не беспокойтесь все настройки и другие данные сохранятся, но без повторного входа вы не сможете получать информацию от МЭШ!";
