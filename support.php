<?php
    ...
    if (R::findOne('meshbotusers', 'tg_id = ?', array($userId))) {
       ...
       $message = "🫥 Добро пожаловать в поддержку бота:\n\n";
       $message .= "📧 ***Электронная почта***: meshbot@vvvorg.com\n";
       $message .= "👨‍💻 ***Контакт поддержки***: @vorg\_support\n";
       $message .= "🌐 ***Соцсети***: [Телеграм канал](https://t.me/meshdnevnik_channel) • [Twitter](https://twitter.com/mesdnevnik_bot)\n\n";
       $message .= "[Политика конфидециальности](https://vorg.site/meshdnevnik_bot/privacy.pdf)\n";
       $message .= "[Пользовательское соглашение](https://vorg.site/meshdnevnik_bot/termofuse.pdf)\n";
       $message .= "\n___Самозанятый СНИМЩИКОВ ЯРОСЛАВ ГЕОРГИЕВИЧ ИНН: 971805068203___";
